   ...
   return (
      <>
         ...
         <div className='fixed bg-black bg-opacity-[0.7] w-full h-full'>
            <div className={success ? "fixed bg-white w-[400px] h-[40vh]  top-[30%] left-[35%] rounded-[10px]" : 'fixed bg-white w-[400px] h-[41vh]  top-[30%] left-[35%] rounded-[10px]'}>
               ...
               <section className='flex justify-center items-center'>
                  <Button
                     ...
                     ClassName={success ? "hidden" : "bg-[#EE095B] w-[150px] h-[40px] text-white rounded-[5px] text-[14px] font-[600] mt-4"}
