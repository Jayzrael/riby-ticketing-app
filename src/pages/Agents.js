...
const Agents = () => {
   ...
   useEffect(() => {
      ...
      setCurrentItems(AgentsList.slice(itemOffset, endOffset));
      setPageCount(Math.ceil(AgentsList.length / itemsPerPage));
   }, [itemOffset, itemsPerPage]);

   // Invoke when user click to request another page.
   const handlePageClick = (event) => {
      const newOffset = (event.selected * itemsPerPage) % AgentsList.length;
      console.log(
